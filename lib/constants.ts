export const FORTIS = {
  company: "Fortis Solutions Group – Fortis Edge",
  shortCompany: "Fortis Solutions Group",
  productName: "Fortis Edge",
  tagline: "Fortis Edge – Simplify Complexity at Speed",
  subhead:
    "Dedicated digital speed plants (Orem, UT + Marietta, GA) for Tier 3 & Tier 4 customers and low-quantity orders.",
  navy: "#003087",
  renewGreen: "#00A651",
  orange: "#F5A623",
} as const;
...
/** ~65% shorter — default marketing copy */
export const FORTIS_CORE_STORY_SHORT =
  "Labels, sleeves, flex packs, cartons, applicators—and Renew™ sustainable options. 1,100+ people nationwide; packaging built for shelf impact and speed.";
